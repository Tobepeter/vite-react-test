    ...
    <div className='pt-10 pl-10 flex flex-col'>
      ...
      <div>
        <label className='flex items-center gap-2'>
          <input type='checkbox' checked={isTranslateX} onChange={e => setIsTranslateX(e.target.checked)} />
          <span className='select-none'>translateX</span>
        </label>
        <label className='flex items-center gap-2'>
          <input type='checkbox' checked={isScale} onChange={e => setIsScale(e.target.checked)} />
          <span className='select-none'>scale</span>
        </label>
        <label className='flex items-center gap-2'>
          <input type='checkbox' checked={isAbsolute} onChange={e => setIsAbsolute(e.target.checked)} />
